...
from ...common import BaseEmbeddingDynamicHandle, find_key_in_kv_config
...
class EmbeddingDynamicHandle(DynamicHandle, BaseEmbeddingDynamicHandle):
    ...
    async def embed_string(self, input_string: str) -> dict[str, List[float]]:
        ...
        """
        return await self._port.call_rpc("embedString", {"specifier": self._specifier, "inputString": input_string})
